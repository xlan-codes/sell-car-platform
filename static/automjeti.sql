...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 28, 2020 at 03:04 PM
...
INSERT INTO `blog_blog` (`id`, `scoper_id`) VALUES
(1, 1),
(2, 2),
(3, 4);
...
--
-- Table structure for table `blog_feedhit`
--

CREATE TABLE `blog_feedhit` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `blog_post` (
  ...
  `markup` varchar(25) NOT NULL,
  `teaser_html` longtext NOT NULL,
...
--
-- Table structure for table `blog_reviewcomment`
--

CREATE TABLE `blog_reviewcomment` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `blog_revision`
--
...
('rty61ciiz4pqftx5p0omkynhzbbfhnn2', '.eJxVjEEOwiAQRe_C2pCBFJi6dO8ZyMxApWogKe3KeHdt0oVu_3vvv1SkbS1x63mJc1Jn5dTpd2OSR647SHeqt6al1XWZWe-KPmjX15by83K4fweFevnWg6AACASgEQIiOW-DjDIkmETIIGXxhtgaHMhYQIDsyZED5uwmVu8P3Hw4Cw:1kMs7a:PBolVeulw9N8HyFDbrPucM_YwbCtRbLI9X5Mz6Inb_E', '2020-10-12 12:19:10.745030');
...
(7, 2020, 20, 120000, 'lorem ipsum', '2020-09-04 16:04:04.185618', 1, 1, 2, 1, 1, 1, 1, 1, 1, 2, 1, 1, 3, 2, 7.7, 7, 6.7, '', 1),
(8, 2019, 30000, 3500000, '', '2020-09-04 16:05:16.343217', 2, 2, 1, 2, 1, 2, 2, 1, 1, 1, 1, 3, 1, 2, NULL, NULL, NULL, '', 1),
(9, 2019, 30000, 3500000, '', '2020-09-04 16:05:16.343217', 2, 2, 1, 2, 1, 2, 2, 1, 1, 1, 1, 3, 1, 2, NULL, NULL, NULL, '', 0),
...
INSERT INTO `users_customuser` (`id`, `password`, `last_login`, `is_superuser`, `first_name`, `last_name`, `email`, `is_staff`, `is_active`, `phone`, `date_joined`, `seller_type_id_id`, `name`, `display_name`) VALUES
(1, 'pbkdf2_sha256$216000$i9y026VA9MLq$SKKVz+MTkJz+D3b8OeeDUehzCVGeJnsCy0PlSMuuEok=', '2020-09-25 18:27:24.646702', 1, '', '', 'a@b.com', 1, 1, '0676247163', '2020-09-04 12:14:34.567568', 2, '', ''),
...
(4, 'pbkdf2_sha256$216000$FpeBDaCnFIKC$faWmB0tPeG8+aiLK589Hoh7ZE/Aj+4Cd5am/lbMSoiU=', '2020-09-11 13:02:49.301767', 0, 'test1', 'testtest', 'b@x.com', 0, 1, '355676247163', '2020-09-11 13:02:48.611061', 2, '', ''),
(5, 'pbkdf2_sha256$216000$GyiFTmUkAmYx$Rd/8kAp0M2IB4Y58SpJU4/G9TFQFngBVpwZ+EJm7JDI=', '2020-09-28 12:19:10.661298', 0, 'test1', 'testtest', 'b@v.com', 0, 1, '355676247163', '2020-09-28 12:19:09.989098', 1, '', '');
...
(13, 'Tirana, Albania', '41.328041390360355,19.818387063754262', 5);
...
ALTER TABLE `blog_blog`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `scoper_id` (`scoper_id`);

--
-- Indexes for table `blog_feedhit`
--
ALTER TABLE `blog_feedhit`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `blog_post`
  ...
  ADD UNIQUE KEY `blog_post_image_set_id_575a992c_uniq` (`image_set_id`),
  ADD KEY `blog_post_slug_b95473f2` (`slug`),
  ADD KEY `blog_post_section_id_a0cb86bb` (`section_id`),
  ADD KEY `blog_post_author_id_dd7a8485_fk_users_customuser_id` (`author_id`),
  ADD KEY `blog_post_blog_id_1d63f737_fk_blog_blog_id` (`blog_id`);

--
-- Indexes for table `blog_reviewcomment`
--
ALTER TABLE `blog_reviewcomment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `blog_reviewcomment_post_id_a3ea933f_fk_blog_post_id` (`post_id`);

--
-- Indexes for table `blog_revision`
--
ALTER TABLE `blog_revision`
  ADD PRIMARY KEY (`id`),
  ADD KEY `blog_revision_author_id_ea7a6b2a_fk_users_customuser_id` (`author_id`),
  ADD KEY `blog_revision_post_id_dd955da5_fk_blog_post_id` (`post_id`);
...
ALTER TABLE `blog_section`
  ...
  ADD UNIQUE KEY `blog_section_name_bd80e085_uniq` (`name`);
...
--
-- AUTO_INCREMENT for table `blog_feedhit`
--
ALTER TABLE `blog_feedhit`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `blog_reviewcomment`
--
ALTER TABLE `blog_reviewcomment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `blog_revision`
--
ALTER TABLE `blog_revision`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `blog_blog`
  ADD CONSTRAINT `blog_blog_scoper_id_232bed2c_fk_users_customuser_id` FOREIGN KEY (`scoper_id`) REFERENCES `users_customuser` (`id`);
...
ALTER TABLE `blog_post`
  ...
  ADD CONSTRAINT `blog_post_blog_id_1d63f737_fk_blog_blog_id` FOREIGN KEY (`blog_id`) REFERENCES `blog_blog` (`id`),
  ADD CONSTRAINT `blog_post_image_set_id_575a992c_fk_pinax_images_imageset_id` FOREIGN KEY (`image_set_id`) REFERENCES `pinax_images_imageset` (`id`),
  ADD CONSTRAINT `blog_post_section_id_a0cb86bb_fk_blog_section_id` FOREIGN KEY (`section_id`) REFERENCES `blog_section` (`id`);

--
-- Constraints for table `blog_reviewcomment`
--
ALTER TABLE `blog_reviewcomment`
  ADD CONSTRAINT `blog_reviewcomment_post_id_a3ea933f_fk_blog_post_id` FOREIGN KEY (`post_id`) REFERENCES `blog_post` (`id`);

--
-- Constraints for table `blog_revision`
--
ALTER TABLE `blog_revision`
  ADD CONSTRAINT `blog_revision_author_id_ea7a6b2a_fk_users_customuser_id` FOREIGN KEY (`author_id`) REFERENCES `users_customuser` (`id`),
  ADD CONSTRAINT `blog_revision_post_id_dd955da5_fk_blog_post_id` FOREIGN KEY (`post_id`) REFERENCES `blog_post` (`id`);
